...
<%-- 				<jsp:include page="layout/info.jsp"/> --%>
        ...
        <div class="jumbotron w-50 mx-auto bg-transparent">
            ...
            <hr class="my-1">
            <form id="register_form" class="mx-auto mt-5 shadow-lg p-3 mb-5 bg-white rounded">
              <h1 class="text-center custom-text-login mb-4">免费注册</h1>
              <div class="form-row">
                ...
                <div class="form-group col-md-6 offset-md-3">
                  ...
                  <input type="password" class="form-control" name="password" placeholder="请输入密码" autocomplete="off" required/>
                  <div class="invalid-feedback" id="password-feedback">密码至少包含一个字母和数字，长度8位以上</div>
                </div>
                <div class="form-group col-md-6 offset-md-3">
                  <i class="fa fa-lock fa-lg"></i>
                  <label for="password_confirm">确认密码</label>
                  <input type="password" class="form-control" name="password_confirm" placeholder="请再次输入密码" autocomplete="off" required/>
               	  <div class="invalid-feedback" id="password_confirm-feedback">两次密码输入不一致</div>
                </div>
              </div>
              <div class="form-group col-md-6 offset-md-3">
              ...
              <button type="button" class="btn btn-dark col-md-3 offset-md-3 mb-5" id="btn_register_confirm">注册</button>
            </form>
          </div>
...
<script src="${ctx}/public/js/register.js"></script>
</html>